...
#define prExportVersion600		8					// CC 2017, addition of support for color profiles
#define EXPORTMOD_VERSION		prExportVersion600	// current version
...
typedef struct
{
	...
	ColorProfileRec	colorProfile;				// if color profile is valid, exporter should embed into output per format standards
} exDoExportRec;
